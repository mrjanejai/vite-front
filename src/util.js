export default {
  ...
  maskInput() {
    window.Inputmask('datetime', { inputFormat: 'yyyy/mm/dd' }).mask('input[data-type=date]')
    window.Inputmask('datetime', { inputFormat: 'HH:MM:ss' }).mask('input[data-type=time]')
    window.Inputmask('datetime', { inputFormat: 'yyyy/mm/dd HH:MM:ss' }).mask('input[data-type=datetime]')
