            ...
            <tbody>
              <tr v-for="orderHeader in orderHeaders" :key="orderHeader">
                ...
                <td class="text-center">
                  <router-link class="btn btn-sm btn-secondary" :to="`/orderHeader/${orderHeader.id}`"><i class="fa fa-eye"></i> View</router-link>
                  <router-link class="btn btn-sm btn-primary" :to="`/orderHeader/edit/${orderHeader.id}`"><i class="fa fa-pencil"></i> Edit</router-link>
                  <router-link class="btn btn-sm btn-danger" :to="`/orderHeader/delete/${orderHeader.id}`"><i class="fa fa-times"></i> Delete</router-link>
                </td>
              </tr>
            </tbody>
          </table>
