      ...
      <div class="col">
        <form method="post">
          <div class="row">
            ...
            <div class="col-12">
              <router-link class="btn btn-sm btn-secondary" :to="getRef('/ma')">Back</router-link>
              <router-link class="btn btn-sm btn-primary" :to="`/ma/edit/${ma.id}?ref=${encodeURIComponent(getRef('/ma'))}`">Edit</router-link>
            </div>
          </div>
        </form>
      </div>
