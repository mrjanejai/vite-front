            ...
            <tbody>
              <tr v-for="userAccount in userAccounts" :key="userAccount">
                ...
                <td class="text-center">
                  <router-link class="btn btn-sm btn-secondary" :to="`/userAccount/${userAccount.id}`"><i class="fa fa-eye"></i> View</router-link>
                  <router-link class="btn btn-sm btn-primary" :to="`/userAccount/edit/${userAccount.id}`"><i class="fa fa-pencil"></i> Edit</router-link>
                  <router-link class="btn btn-sm btn-danger" :to="`/userAccount/delete/${userAccount.id}`"><i class="fa fa-times"></i> Delete</router-link>
                </td>
              </tr>
            </tbody>
          </table>
