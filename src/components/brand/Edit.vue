                ...
                <tbody>
                  <tr v-for="brandProduct in brandProducts" :key="brandProduct">
                    ...
                    <td class="text-center">
                      <router-link class="btn btn-sm btn-secondary" :to="`/product/${brandProduct.id}`"><i class="fa fa-eye"></i> View</router-link>
                      <router-link class="btn btn-sm btn-primary" :to="`/product/edit/${brandProduct.id}`"><i class="fa fa-pencil"></i> Edit</router-link>
                      <router-link class="btn btn-sm btn-danger" :to="`/product/delete/${brandProduct.id}`"><i class="fa fa-times"></i> Delete</router-link>
                    </td>
                  </tr>
                </tbody>
              </table>
